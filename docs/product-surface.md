...
| Generated beta | Recursive Observe's generic Agent Skill, Claude package, and local Codex package | Generated artifacts, raw-byte package receipt, standalone execution, historical version 1 Claude acceptance, and the superseding Windows Codex 0.145.0 version 2 immutable-ref install/cache/rollback run pass; fresh Claude version 2 installation and hosted persistence remain acceptance work |
