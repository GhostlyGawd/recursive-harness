...
| Generated beta | Recursive Observe's generic Agent Skill, Claude package, and local Codex package | Generated artifacts, source receipt, standalone execution, zero-write coexistence, isolated Claude acceptance, and immutable-ref Codex install/cache execution pass; hosted persistence remains acceptance work |
