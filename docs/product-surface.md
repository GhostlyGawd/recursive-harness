...
| Planned | Namespaced Lab provider package | Its manifest defines the intended boundary, but no provider package is supported until generated artifacts, a hash receipt, coexistence fixtures, and consumer evidence land |
