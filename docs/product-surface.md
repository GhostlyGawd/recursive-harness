...
| Generated beta | Recursive Observe's generic Agent Skill, Claude package, and local Codex package | Generated artifacts, raw-byte package receipt, standalone execution, historical version 1 Claude acceptance, and a historical Windows Codex 0.145.0 version 2 run exist; a superseding Codex run, fresh Claude version 2 installation, and hosted persistence remain acceptance work |
