...
| Planned | Namespaced Learn, Verify, Coordinate, and Lab provider packages | Manifests define the intended boundary, but no provider package is supported until generated artifacts, hash receipts, coexistence fixtures, and consumer evidence land |
