...
**Build stamp** - generated `2026-07-17` from extract.py @ `d8939b3`  -  ⚠ built from a MODIFIED extract.py.

| Graph | Value |
|---|---|
| Nodes | **162** (adr=12, agent=4, cli=21, command=14, config=3, evals=12, event=6, hook=21, kernel=1, lint=1, session=38, skill=23, state=6) |
| Edges | **330** (born_in=63, cites=47, fires_on=22, invokes=46, nudges=68, references=34, spawns=19, touches=13, wires=18) |
...
| **Self-improvement loops** | 62 | inner predict->act->score / middle /retro / outer /meta-retro - the three nested learning cycles. |
