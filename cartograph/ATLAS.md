...
| Graph | Value |
|---|---|
| Nodes | **157** (adr=12, agent=4, cli=16, command=14, config=3, evals=12, event=6, hook=21, kernel=1, lint=1, session=38, skill=23, state=6) |
| Edges | **328** (born_in=63, cites=47, fires_on=22, invokes=44, nudges=69, references=34, spawns=19, touches=12, wires=18) |
...
| `invokes` | 44 | artifact → CLI subcommand (harness <cmd>) |
