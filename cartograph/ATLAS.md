...
| Graph | Value |
|---|---|
| Nodes | **160** (adr=12, agent=4, cli=20, command=14, config=3, evals=12, event=6, hook=21, kernel=1, lint=1, session=38, skill=22, state=6) |
| Edges | **328** (born_in=62, cites=47, fires_on=22, invokes=45, nudges=68, references=34, spawns=19, touches=13, wires=18) |
...
| transporter | cli | 20 | move metabolites in/out of the ledgers (CLI) |
...
| **tests** | selection | 27 | shipped | Harness-level pytest integration suite for guards, features, hooks, state - run in CI. |
