...
| Edges | **321** (born_in=60, cites=47, fires_on=22, invokes=42, nudges=68, references=34, spawns=18, touches=12, wires=18) |
...
| `invokes` | 42 | artifact → CLI subcommand (harness <cmd>) |
