...
| Graph | Value |
|---|---|
| Nodes | **133** (adr=9, agent=4, cli=14, command=13, config=3, evals=10, event=6, hook=17, kernel=1, lint=1, session=29, skill=19, state=7) |
| Edges | **285** (born_in=52, cites=39, fires_on=20, invokes=38, nudges=61, references=28, spawns=18, touches=13, wires=16) |
...
| **Self-improvement loops** | 50 | inner predict->act->score / middle /retro / outer /meta-retro - the three nested learning cycles. |
...
| `invokes` | 38 | artifact → CLI subcommand (harness <cmd>) |
