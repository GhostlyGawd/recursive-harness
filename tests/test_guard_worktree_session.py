...
def new_main_tree():
    ...
    # CODEQL-TRIAGE: d is a test-owned temporary fixture and _HOOK_SRC is reviewed code.
    ...
    # CODEQL-TRIAGE: both source and destination are test-owned fixture capabilities.
    shutil.copyfile(
