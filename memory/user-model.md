...
- explain any human-facing surface — settings/feature menus, options, AND status during long autonomous runs — in plain OUTCOME language ("what changes if you flip this"; "what I did / why I'm stuck"), never internal jargon (no "TIER-2 env-gated exit-2", raw session IDs, follow-up hashes, guard/env-var names); the user's model is "treat it like a video game that explains each setting" and jargon-heavy status mid-run loses them entirely (evidence: 2, last: 2026-06-19, source: corrections)
