...
|---|---|---|---|---|
| SessionStart | `session_start.py` | startup/resume/clear | `c72ba4a` (harness v0.1.0, ADR 0001); autonomy-progress line added 2026-07-05 (roadmap item 10, session 975732da, human-granted marker cycle) | Session banner: calibration %, unscored-prediction debt, meta-retro cadence; full banner also shows autonomy graduation progress (`skills 14/20 · …`) — the 20-proposal bar only motivates if visible between /meta-retros. ⚠ Oddity 1 below |
