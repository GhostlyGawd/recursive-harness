...
- **Part of:** the Mission Control build (`proposals/2026-06-21-mission-control-tui.md`). P0–P4
...
<!-- provenance: session pickup 2026-06-23 of the Mission Control build (proposals/2026-06-21-mission-control-tui.md).
