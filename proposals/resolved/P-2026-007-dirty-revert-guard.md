---
id: P-2026-007
title: Proposal — `guard_dirty_revert`: block `git checkout`/`restore` that discards uncommitted work
status: approved
...
- **Status:** RESOLVED 2026-06-21 → folded into hooks/guard_git_worktree_safety.py (combined with the retired guard_branch_first, net hook count 0 per correction 31). See proposals/resolved/P-2026-008-guard-cluster-consolidation.md.
- **Date:** 2026-06-21
