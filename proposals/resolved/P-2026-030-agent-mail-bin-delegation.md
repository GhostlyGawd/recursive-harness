---
id: P-2026-030
title: Agent Mail — the one gated change: thin `bin/harness fleet` → `fleet.cli` delegation
status: approved
...
def cmd_fleet(args) -> int:
    ...
    further bin/harness edit. See proposals/resolved/P-2026-012-agent-mail-product.md + fleet/pm/specs/ARCHITECTURE.md."""
