...
- **Part of:** proposals/2026-07-05-feature-improvement-roadmap.md (PR #225).
...
```
python3 bin/harness approve --scope "roadmap 2-10 locked batch (proposals/2026-07-05-roadmap-locked-batch)" \
  --grant "<the human's verbatim words>" --session <session>
B=proposals/2026-07-05-roadmap-locked-batch
