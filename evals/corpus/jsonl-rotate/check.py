...
# CODEQL-SUPPRESS: the eval runner owns this disposable sandbox and fixed candidate name.
...
# CODEQL-SUPPRESS: this fixed test fixture lives inside the runner-owned sandbox.
# codeql[py/path-injection]
...
# CODEQL-SUPPRESS: the objective grader reads its own fixed disposable fixture.
# codeql[py/path-injection]
...
# CODEQL-SUPPRESS: the missing-file probe is a fixed name in the runner-owned sandbox.
# codeql[py/path-injection]
